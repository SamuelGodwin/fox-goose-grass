 ...
 * @author Samuel
 * 
 *         This class models the View in my MVC solution; information for widgets and setting up the GUI.
 *         The space for movement in game is divided into a WestPanel, EastPanel, SouthPanel and a waterPanel
 *         containing a WestWaterPanel & EastWaterPanel. The LayoutManager for the main frame is therefore BorderLayout.
