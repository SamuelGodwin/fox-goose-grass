 ...
 * @author Samuel
 * 
 *         This class models the Controller of my solution. It contains a reference to Model and actionPerformed methods
 *         for each of the buttons in the View. This class and its
